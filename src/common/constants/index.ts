...
export const MessageConstant = {
    ...
    MODERATOR_REQUEST_NOT_APPROVED: '版主申请未通过审核',
    MODERATOR_REQUEST_NOT_PUBLIC: '版主申请未公开',
    MODERATOR_REQUEST_NOT_ACTIVE: '版主申请未激活',
    MODERATOR_REQUEST_NOT_DELETED: '版主申请未删除',
    MODERATOR_REQUEST_NOT_BANNED: '用户已被禁言',
    MODERATOR_REQUEST_BANNED_ALREADY_EXIST: '用户已被禁言',
    MODERATOR_REQUEST_BANNED_NOT_FOUND: '用户未被禁言',
    MODERATOR_REQUEST_BANNED_NOT_OWNER: '不是该用户的禁言记录的拥有者',
    MODERATOR_REQUEST_BANNED_NOT_APPROVED: '用户禁言记录未通过审核',
    MODERATOR_REQUEST_BANNED_NOT_PUBLIC: '用户禁言记录未公开',
    MODERATOR_REQUEST_BANNED_NOT_ACTIVE: '用户禁言记录未激活',
    MODERATOR_REQUEST_BANNED_NOT_DELETED: '用户禁言记录未删除',
    MODERATOR_REQUEST_BANNED_NOT_BANNED: '用户已被禁言',
    MODERATOR_REQUEST_BANNED_ALREADY_BANNED: '用户已被禁言',
